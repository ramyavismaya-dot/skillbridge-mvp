    ...
    <div className="space-y-10">
      ...
      <section className="grid md:grid-cols-3 gap-6">
        <div className="card space-y-3">
          <h2 className="font-bold text-lg text-navy">Student</h2>
          <p className="text-sm text-gray-600">
            Take the assessment, get an AI-generated career report, and a training roadmap.
          </p>
          <Link href="/student" className="btn-primary">Start assessment</Link>
        </div>
        <div className="card space-y-3">
          <h2 className="font-bold text-lg text-navy">University</h2>
          <p className="text-sm text-gray-600">
            Career-services view: cohort interests, skill gaps, and top career clusters.
          </p>
          <Link href="/university" className="btn-primary">View dashboard</Link>
        </div>
        <div className="card space-y-3">
          <h2 className="font-bold text-lg text-navy">Employer</h2>
          <p className="text-sm text-gray-600">
            Post a role and see ranked, verified candidates from the student database.
          </p>
          <Link href="/employer" className="btn-primary">View jobs</Link>
        </div>
      </section>
    </div>
  );
