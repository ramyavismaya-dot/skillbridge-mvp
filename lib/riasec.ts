...
// 3 questions each, 1-5 Likert) combined with a 6-dimension self-rated skill
// profile. This is a reasonable, widely-used, non-proprietary starting point
// for a real product — but it is NOT a validated psychometric instrument.
// Before this output is used to influence real hiring or advising decisions,
// have an I/O psychologist review/replace the item bank (see business plan,
...
export const RIASEC_QUESTIONS: Question[] = [
  ...
  { id: "r3", code: "R", text: "I like clear, practical problems more than abstract theory." },
  ...
  { id: "i3", code: "I", text: "I am drawn to science, math, or technical problem-solving." },
  ...
  { id: "a3", code: "A", text: "I value self-expression and originality in my work." },
  ...
  { id: "s3", code: "S", text: "I care a lot about the wellbeing of people around me." },
  ...
  { id: "e3", code: "E", text: "I am comfortable with risk-taking and competition." },
  ...
  { id: "c3", code: "C", text: "I am detail-oriented and value precision over speed." },
  ];
